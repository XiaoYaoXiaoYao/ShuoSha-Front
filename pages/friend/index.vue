<template>
<div>
  <div class="banner" style="background-color: #f9f9f9;">
    <div class="wrapper">
      <img src="~/assets/img/jiaoyou-top.png" alt=""/>
    </div>
  </div>
  <!--两列布局-->
  <div class="wrapper tag-item">
        ...
        <ul class="friends">
          <li class="friend-item">
            <div class="fl photo">
              ...
              <div class="img">
                <img src="~/assets/img/aliyun10.png" alt=""/>
              </div>
              <div class="tag">
                <span class="tag-cafe cafe"><i class="fa fa-coffee" aria-hidden="true"></i> 云栖大会的一些问题</span>
              </div>
            </div>
            <div class="fl content">
              <p class="title"><span class="name">阿里云</span> 邀你一起 <span class="cafe">云栖大会的一些问题</span> <b
          ...
          <li class="friend-item">
            ...
            <div class="fl content">
              <p class="title"><span class="name">阿里云</span> 邀你一起 <span class="eat">吃饭</span> <b class="bold">匹配度
                96%</b></p>
              <p class="aa"><span class="money"> 24岁 | 金牛座 | 教育 | 软件工程师</span></p>
              <p class="point">他刚刚分享了XXX文章</p>
              <p class="desc">推荐理由：你们共同关注PHP、Python 等 5 个标签，都关注 XXX 活动。</p>
          ...
          <li class="friend-item">
            ...
            <div class="fl content">
              <p class="title"><span class="name">阿里云</span> 邀你一起 <span class="travel">旅行</span><b
                class="bold">匹配度 96%</b></p>
              <p class="aa"><span class="money"> 24岁 | 金牛座 | 教育 | 软件工程师</span></p>
              <p class="point">他刚刚分享了XXX文章</p>
              <p class="desc">推荐理由：你们共同关注PHP、Python 等 5 个标签，都关注 XXX 活动。</p>
          ...
          <li class="friend-item">
            ...
            <div class="fl content">
              <p class="title"><span class="name">阿里云</span> 邀你一起<span class="sing">K歌</span><b class="bold">匹配度
                96%</b></p>
              <p class="aa"><span class="money"> 24岁 | 金牛座 | 教育 | 软件工程师</span></p>
              <p class="point">他刚刚分享了XXX文章</p>
              <p class="desc">推荐理由：你们共同关注PHP、Python 等 5 个标签，都关注 XXX 活动。</p>
          ...
          <li class="friend-item">
            ...
            <div class="fl content">
              <p class="title"><span class="name">阿里云</span> 邀你一起<span class="movie">看电影</span><b
                class="bold">匹配度 96%</b></p>
              <p class="aa"><span class="money"> 24岁 | 金牛座 | 教育 | 软件工程师</span></p>
              <p class="point">他刚刚分享了XXX文章</p>
              <p class="desc">推荐理由：你们共同关注PHP、Python 等 5 个标签，都关注 XXX 活动。</p>
          ...
          <li class="friend-item">
            ...
            <div class="fl content">
              <p class="title"><span class="name">阿里云</span> 邀你一起 <span class="other">其他</span><b
                class="bold">匹配度 96%</b></p>
              <p class="aa"><span class="money"> 24岁 | 金牛座 | 教育 | 软件工程师</span></p>
              <p class="point">他刚刚分享了XXX文章</p>
              <p class="desc">推荐理由：你们共同关注PHP、Python 等 5 个标签，都关注 XXX 活动。</p>
    ...
    <div class="fl right-tag">
      ...
      <div class="block-btn">
        <p>约一约有趣的人，会一会好的时光！</p>
        <a class="sui-btn btn-block btn-share" href="./makeFriends-submit.html" target="_blank">一键邀请</a>
      </div>
      <div class="rank">
        <div class="head">
        ...
        <div class="rank-list">
          <ul class="rank">
            <li><span class="fl dating">云栖大会的一些问题</span> <span class="fr cafe">102258</span></li>
