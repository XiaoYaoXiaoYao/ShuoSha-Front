         ...
         <div class="job-position">
           <div class="job-type reco-job">
             ...
             <ul class="yui3-g job-list" style="display:block;">
               <li class="yui3-u-1-2 job-item"><p><span class="name"><a href="./recruit-detail.html"
                                                                        target="_blank">阿里云Java开发工程师</a></span><span
                 class="city"><i class="fa fa-map-marker"></i> 北京</span></p>
                 <p class="need"><span class="money">200K-300K</span>/经验10-15年/本科及以上/全职</p>
                 <p><span class="company">阿里云 &middot; 10天前</span></p></li>
               <li class="yui3-u-1-2 job-item"><p><span class="name">阿里云Java开发工程师</span><span class="city"><i
           ...
           <div class="job-type latest-job">
             ...
             <ul class="yui3-g job-list" style="display:block;">
               <li class="yui3-u-1-2 job-item"><p><span class="name"> <a href="./recruit-jobDetail.html"
                                                                         target="_blank">阿里云Java开发工程师</a></span><span
                 class="city"><i class="fa fa-map-marker"></i> 北京</span></p>
                 <p class="need"><span class="money">200K-300K</span>/经验10-15年/本科及以上/全职</p>
                 <p><span class="company">阿里云 &middot; 10天前</span></p></li>
         ...
         <div class="hot-company">
           ...
           <div class="company">
             ...
             <ul class="yui3-g company" style="display:block;">
               <li class="yui3-u-1-3 company-item"><p><img src="~/assets/img/aliyun-logo.png" alt=""/></p>
                 <p class="title">阿里云</p>
